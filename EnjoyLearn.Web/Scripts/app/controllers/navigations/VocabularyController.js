define(['appModule'], function (app) {
    app.lazy.controller('VocabularyController',
    [
        '$scope',
        '$http',
        '$dialog',
        ...
        function (scope, $http, $dialog, context, validation, events) {
            scope.name = 'My Vocabulary';
            scope.loading = true;
            scope.words = [];

            var init = function () {
                scope.loading = false;
                scope.rowCollection = context.userDictionaryWords;
