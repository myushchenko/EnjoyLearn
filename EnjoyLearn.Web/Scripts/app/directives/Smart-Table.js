...
(function (angular) {
    ...
    angular.module('smartTable.directives', ['smartTable.templateUrlList', 'smartTable.templates'])
        ...
        .directive('smartTableDataRow', function ($dialog) {
            ...
            return {
                ...
                link: function (scope, element, attr, ctrl) {
                    ...
                    element.bind('click', function () {
                        ...
                        //scope.onEditWord(scope.dataRow);
                    ...
                    scope.onEditWord = function (dataRow) {
                        ...
                        scope.optsAddWordDialog = {
                            ...
                            resolve: { item: function () { return angular.copy(dataRow); } }
                        };
        ...
        .directive('editableCell', ['templateUrlList', '$parse', '$dialog', function (templateList, parse, $dialog) {
            return {
                restrict: 'EA',
                require: '^smartTable',
...
angular.module("partials/editableCell.html", []).run(["$templateCache", function ($templateCache) {
    $templateCache.put("partials/editableCell.html",
      "<div ng-click=\"toggleEditMode($event)\">\n" +
